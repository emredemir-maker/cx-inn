...
import { cxAnalysesTable, interactionRecordsTable, customersTable, tagSynonymsTable } from "@workspace/db";
...
GÖREV: Bu etkileşimlere dayanarak aşağıdaki analizi JSON formatında döndür:
{
  ...
  "keyTopics": [<en fazla 7 konu etiketi — kısa, tek veya iki kelimelik Türkçe etiketler, KANONİK SÖZLÜKTEN seç>],
  "interactionTags": { "<interaction_id>": [<2-4 kısa Türkçe etiket, KANONİK SÖZLÜKTEN seç>] },
