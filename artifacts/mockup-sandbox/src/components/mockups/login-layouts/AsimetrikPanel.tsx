...
export function AsimetrikPanel() {
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between px-12 py-6 border-b border-slate-800/60">
            <div>
              <span className="text-xl font-bold text-white">CX<span className="text-indigo-400">-Inn</span></span>
              <span className="ml-3 text-xs text-slate-600 font-medium tracking-wide">B2B CX Platformu</span>
            </div>
          ...
          {/* Center — two column: heading left, login right */}
            ...
            <div className="flex flex-col justify-center px-12 pr-8 space-y-8">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <div key={label} className="flex flex-col items-start px-4 py-3 rounded-xl bg-slate-900 border border-slate-800">
              ...
              <div className="w-full max-w-sm">
                <div className="rounded-2xl border border-slate-700/60 bg-slate-900/80 p-8 space-y-6 shadow-2xl">
                  <div className="text-center space-y-1.5">
                    ...
                    <p className="text-slate-400 text-xs">Google hesabınızla güvenli erişim</p>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center">
                      <span className="px-3 text-[10px] text-slate-600 bg-slate-900">Güvenli kimlik doğrulama</span>
                    </div>
                  </div>

                  <div className="space-y-2">
                    {["Google tek tıkla giriş", "httpOnly şifreli çerez", "Firebase Auth koruması"].map((item) => (
                ...
                <p className="text-center text-[10px] text-slate-700 mt-5">CX-Inn Platform © 2026</p>
              </div>
            </div>
          </div>
